...
export function GET() {
  ...
  const lines = [
    "# 寰引智能",
    "",
    "> 寰引智能科技（深圳）有限公司，是面向企业客户的 AI 转型落地服务商，提供 AI 智能体、AI 文档处理、业务自动化、AI 数据应用、AI 搜索增长（GEO/AEO）和企业系统定制开发服务。",
    "",
    "## 关于我们",
    `寰引智能科技（深圳）有限公司，已服务 ${statValue("企业客户")} 企业客户，交付 ${statValue("落地系统")} 智能化系统，`,
    "覆盖报关、跨境物流、跨境电商、物流、电商客服、业务自动化、供应链及制造外贸相关场景。",
    "",
    "## 核心事实",
    `- 企业客户：${statValue("企业客户")}`,
    ...
    "- 业务自动化：ERP/WMS/TMS 批量录入、模板转换、电子章、轨迹抓取、流程衔接（含 RPA）",
    "- AI 数据应用：物流轨迹追踪、商品采集监控、异常预警、经营看板",
